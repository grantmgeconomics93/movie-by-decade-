...
```{r}
ggplot(dummyfulldata, aes(budget)) +
  stat_ecdf(geom = "step", pad = FALSE)
ggplot(exblockbuster,aes(budget))+stat_ecdf(geom = "step",pad = FALSE)

# Density curve
ggplot(dummyfulldata, aes(x=budget )) + geom_density()
# Density curve
ggplot(exblockbuster, aes(x=budget )) + geom_density()
