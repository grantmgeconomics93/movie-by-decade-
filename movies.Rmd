...
biggestmovie$"1960s"=ifelse(biggestmovie$year<1970 & biggestmovie$year>=1960,0,0)
...
```
```{r}
summary(lm(biggestmovie$runtime ~biggestmovie$budget))
summary(lm(biggestmovie$runtime ~biggestmovie$budget+biggestmovie$`2000s`))
```
```{r}
summary(lm(bslicedmovieten$gross~bslicedmovieten$budget))
```
