...
```
```{r}
lm(biggestmovie$revenue~biggestmovie$budget+biggestmovie$`1990s`+biggestmovie$`2000s`+biggestmovie$`2010s`)
```
```{r}
lm(bslicedmovieten$revenue~bslicedmovieten$budget+bslicedmovieten$`1990s`+bslicedmovieten$`2000s`+bslicedmovieten$`2010s`)
```
